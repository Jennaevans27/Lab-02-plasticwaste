...
```{r plastic_waste_per_cap_dis-hist, eval=TRUE}
ggplot(data = plastic_waste, aes(x = plastic_waste_per_cap)) +
  geom_histogram(binwidth = 0.2) +
  facet_wrap (~ continent) +
  labs(title = "Plastic Waste per Capita Distribution",
...
Color and fill is used to represent different variables in data and change based on the data that we have , where alpha controls transparency which is not direclty link with the data. 
